...
<div class="div-ejercicio">
    ...
    <p class="enunciado"><b>ENUNCIADO:</b> Realizar una web que muestre todas las imágenes que contiene en la carpeta
        “/imagenes” con su
    ...
    <br>
        ...
        $imagenes = array();
        /*PARA QUE CAPTURE SOLO DEL TIPO IMAGEN*/
        ...
        foreach ($imagenes as $img) {
            ...
            echo '<img src="' . $ruta_imagenes . $img . '" alt="'. $img . '">';
            echo '<span class="alt-text">' . $img . '</span>';
            echo '</div>';
            echo '<br>';
        }
        ?>
